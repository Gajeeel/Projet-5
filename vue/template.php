                ...
                <div class="container-fluid">
                    ...
                    <div class="collapse navbar-collapse" style="text-align:center;" id="monMenu">
                        ...
                        <ul class="nav navbar-nav navbar-right">
                            ...
                            ?>
                            <li <?=$_SERVER['REQUEST_URI'] == '/index.php?action=gotoconnexion' ? ' class="active"' : ''?> ><a href="index.php?action=gotoconnexion"><span class=" glyphicon glyphicon-log-in"></span> Connexion</a></li>
                            <?php
                            }
                            ?>
                        </ul>
